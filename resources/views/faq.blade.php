                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        SIMAPES adalah sebuah website yang menyediakan sistem pembayaran SPP online untuk
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    ...
                                    <div class="accordion-body">
                                        SIMAPES dibuat untuk membuat kemudahan pengecekan data spp agar dapat diakses
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed fw-bold" type="button"
                                        ...
                                        Bagaimana cara menggunakan SIMAPES?
                                    </button>
                                </h2>
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        1.
                                        Login ke aplikasi SIMAPES Menggunakan Username & Password yang telah diberikan
        ...
        <section class="bonus-section mt-100">
            <div class="container">
                ...
                0 100px 100px rgba(0, 0, 0, 0.05);">
                    ...
                    <p class="lead">Tunggu apa lagi? segera coba aplikasi SIMAPES agar anda dapat melihat history
