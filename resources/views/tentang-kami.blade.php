        ...
        <section class="content mt-5">
            <div class="row">
                <div class="col-md-12 mx-auto text-start">
                    ...
                    <h1 class="fw-bold" data-aos="fade-up" data-aos-duration="1200">APA ITU SI<span class="fs-1 fw-bold " data-aos="fade-up" data-aos-duration="1100" style="color:#66CC66">MAP</span>ES</span>?</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-7 my-auto">
                    ...
                    <p data-aos="fade-up" data-aos-duration="1400">
                        ...
                        SIMAPES dibuat untuk membuat kemudahan pengecekan data spp agar dapat diakses dimana saja dan
                        kapan saja!
                    </p>
    ...
    <section class="about-section-2 " style="background-color: #f2f6fb">
        <div class="container">
            <div class="row flex-column-reverse flex-md-row">
                <div class="col-md-7 my-auto">
                    <p data-aos="fade-up" data-aos-duration="1000" class="text-primary label-top">TENTANG SIMAPES</p>
                    <h1 data-aos="fade-up" data-aos-duration="1200">Dengan SI<span class="fs-1 fw-bold " data-aos="fade-up" data-aos-duration="1100" style="color:#66CC66">MAP</span>ES</span> semua jadi lebih mudah!</h1>
                    <p data-aos="fade-up" data-aos-duration="1400">
                        ...
                        mereka bisa meggunakan SIMAPES untuk melihatnya kapan saja dimana saja
                    </p>
                    <a id="cara-lapor" href="{{url('/auth')}}">
                        <p data-aos="fade-up" data-aos-duration="1600" class="text-primary"
                            style="text-decoration: none"> Selengkapnya →</p>
