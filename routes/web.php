...
->group(function(){
	Route::post('test', 'SiswaController@payment_post')->name('siswa.test');
	Route::get('test', 'SiswaController@pay')->name('siswa.test');
	Route::get('pembayaran-online', 'SiswaController@pembayaranOnline')->name('siswa.pembayaran-online');
